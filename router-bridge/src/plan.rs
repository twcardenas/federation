...
///
/// We use a generic here because the output type `QueryPlan` it part of the router.
/// Since this bridge is temporary we don't want it to become too big and own too many types.
pub fn plan<T: DeserializeOwned + 'static>(
    ...
    Js::new()
        ...
        .with_parameter("operationName", context.operation)
